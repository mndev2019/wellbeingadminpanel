    ...
    return (
        <>
            <section className="px-2">
                <PageHeader title="Community Engagement" filter="show" weekly="show" />
                                                ...
                                                <tr className="*:text-start *:text-[13px] *:font-[400] bg-[#FFFFFF] *:px-[1rem] *:py-[1rem] *:tracking-[0.5px] *:border-r *:text-nowrap *:border-gray-100">
                                                    <td>
                                                        <div className="flex items-center gap-3">
                                                            <div className="icon w-8 h-8 rounded-full">
                                                                <img src={tableimage} alt="image" className="rounded-full w-8 h-8 object-cover" />
                                                            </div>
                                                            <div className="text">
                                                                Lindsey Stroud
                                                            </div>
